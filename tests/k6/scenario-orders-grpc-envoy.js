// Scenario 5: gRPC-Web CreateOrder via Envoy proxy (:8080)
...
const latency = new Trend('grpc_web_orders_latency', true);
const errors  = new Rate('grpc_web_orders_errors');
...
export default function () {
  ...
  const res = http.post(
    `${BASE_URLS.envoy}/order.OrderService/CreateOrder`,
    body.buffer,
    {
      headers: {
